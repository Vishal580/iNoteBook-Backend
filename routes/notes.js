...
router.put('/updatenote/:id', fetchuser, async (req, res)=>{
    ...
    //Check whether the owner of the note is accessing the note
...
// ROUTE: 5 Update Tag Color using : PUT "/api/notes/updateTagColor". It requires auth
router.put('/updateTagColor/:id', fetchuser, async (req, res) => {
    const { tagColor } = req.body;
